 ...
 */
final class Version20220331105847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE table_booking ADD time_sheet LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
