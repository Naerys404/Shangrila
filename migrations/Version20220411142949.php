 ...
 */
final class Version20220411142949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD delivery_address LONGTEXT NOT NULL, DROP stripe_token, DROP brand_stripe, DROP last4_stripe, DROP id_charge_stripe, DROP status_stripe, DROP updated_at');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD stripe_token VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD brand_stripe VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD last4_stripe VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD id_charge_stripe VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD status_stripe VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD updated_at DATETIME NOT NULL, DROP delivery_address, CHANGE reference reference VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
