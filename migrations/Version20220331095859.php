 ...
 */
final class Version20220331095859 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE table_booking CHANGE time_sheet time_sheet LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
